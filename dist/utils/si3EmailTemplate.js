...
exports.si3RSVPConfirmationTemplate = void 0;
 ...
 */
const si3RSVPConfirmationTemplate = (data) => {
    ...
    <body>
        ...
        timeZoneName: 'short'
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    <div class="detail-value">
                                        ...
                                        ${((_a = event.location) === null || _a === void 0 ? void 0 : _a.type) === 'virtual' && ((_b = event.location) === null || _b === void 0 ? void 0 : _b.virtualLink) ? `<br><span style="color: #6B7280; font-size: 14px; margin-top: 4px; display: block;">${event.location.virtualLink}</span><a href="${event.location.virtualLink}" style="color: #3B82F6; text-decoration: none; font-weight: 600; font-size: 15px; margin-top: 4px; display: inline-block;">→ Join Meeting</a>` : ''}
                                    </div>
                                </div>
                            </div>
                            ` : ''}
                        ...
                        ${((_c = event.location) === null || _c === void 0 ? void 0 : _c.type) === 'virtual' && ((_d = event.location) === null || _d === void 0 ? void 0 : _d.virtualLink) && ((_e = event.location) === null || _e === void 0 ? void 0 : _e.accessInstructions) ? `
                    ...
                    <p style="margin-top: 32px; font-size: 16px; color: #1F2937;">
                        Best regards,<br>
                        <strong>${((_f = event.organizer) === null || _f === void 0 ? void 0 : _f.name) || 'SI3 Events Team'}</strong><br>
                ...
                <div class="footer">
                    ...
                    <p class="footer-text">For questions or support, contact: <strong>${((_g = event.organizer) === null || _g === void 0 ? void 0 : _g.email) || 'guides@si3.space'}</strong></p>
...
exports.si3RSVPConfirmationTemplate = si3RSVPConfirmationTemplate;
