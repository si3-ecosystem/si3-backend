 ...
 */
const sendEmailOTP = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
const requestWalletSignature = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.requestWalletSignature = requestWalletSignature;
/**
 * Verify wallet signature and login/register user
 */
const verifyWalletSignature = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
const connectWallet = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { wallet_address, signature } = req.body;
        const user = req.user;
        // Get nonce from Redis
 ...
 */
const disconnectWallet = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
