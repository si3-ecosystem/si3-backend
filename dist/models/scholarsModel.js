...
// Schema definition
const scholarsProgramSchema = new mongoose_1.Schema({
    name: {
        type: String,
...
scholarsProgramSchema.post("save", function (error, doc, next) {
    console.log("Error in scholarsProgramSchema.post:", error);
    if (error.name === "MongoServerError" && error.code === 11000) {
        const duplicateError = new Error("A scholar with this email already exists");
...
const ScholarsProgramModel = mongoose_1.default.model("Scholar", scholarsProgramSchema);
exports.default = ScholarsProgramModel;
