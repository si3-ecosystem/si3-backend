...
class EmailService {
    sendPurchaseNotification(buyerData, transactionHash) {
...
${new Date().toISOString()}
        `.trim()
                ...
                const info = yield protonMail_1.default.sendEmail({
    ...
    sendTestEmail(toEmail) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.sendCustomEmail(testEmail, "🧪 SI3 Email Service Test", `
