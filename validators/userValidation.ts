 ...
 */
export const validateWalletActivity = [
 ...
 */
export const validateEnhancedProfile = [
  body("email")
    .optional()
    .isEmail()
    .normalizeEmail()
  ...
  body("notificationSettings.emailUpdates")
    .optional()
    .isBoolean()
    .withMessage("emailUpdates must be a boolean"),

  body("notificationSettings.sessionReminder")
    .optional()
    .isBoolean()
    .withMessage("sessionReminder must be a boolean"),

  body("notificationSettings.marketingEmails")
    .optional()
    .isBoolean()
    .withMessage("marketingEmails must be a boolean"),

  body("notificationSettings.weeklyDigest")
    .optional()
    .isBoolean()
    .withMessage("weeklyDigest must be a boolean"),

  body("notificationSettings.eventAnnouncements")
    .optional()
    .isBoolean()
    .withMessage("eventAnnouncements must be a boolean"),
  ...
  body("walletInfo.connectedWallet")
    .optional()
    .isIn(["Zerion", "MetaMask", "WalletConnect", "Other"])
    .withMessage("Invalid wallet type"),

  body("walletInfo.network")
    .optional()
    .isIn(["Mainnet", "Polygon", "Arbitrum", "Base", "Optimism"])
 ...
 */
export const validatePartialNotificationSettings = [
  body("emailUpdates")
    .optional()
    .isBoolean()
    .withMessage("emailUpdates must be a boolean"),
