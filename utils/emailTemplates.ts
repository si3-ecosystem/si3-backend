...
export const scholarsReplyTemplate = (data: ScholarsSubmissionData): string => {
  return `
    <!DOCTYPE html><html lang="en"> <head> <meta charset="UTF-8" /> <meta name="viewport" content="width=device-width, initial-scale=1" /> <title>Thank You for Applying!</title> <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Montserrat:wght@500;700&display=swap" rel="stylesheet" /> <style> body { margin: 0; padding: 0; background-color: #f4f4f4; font-family: 'Inter', Arial, sans-serif; } .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e0d5ff; } .header { background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #fff; padding: 24px; text-align: center; } .header h1 { margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; font-weight: 700; } .content { padding: 30px; color: #333; } .content p { font-size: 16px; line-height: 1.6; margin: 0 0 20px; color: #555; } .cta { text-align: center; margin-top: 30px; } .cta a { display: inline-block; padding: 12px 28px; background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #fff; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 16px; text-decoration: none; border-radius: 50px; } .footer { text-align: center; font-size: 13px; color: #999; padding: 20px; } @media only screen and (max-width: 600px) { .content { padding: 20px; } } </style> </head> <body> <div class="email-container"> <div class="header"> <h1>Thank You for Applying!</h1> </div> <div class="content"> <p>Hi ${data.name},</p> <p>Thank you for applying to the <strong>Scholars Program</strong>. We’ve received your application and are excited to learn more about your journey and interests in Web3.</p> <p>Our team will review your submission and reach out shortly with next steps. In the meantime, stay connected and feel free to explore our resources and community links.</p> <div class="cta"> <a href="https://www.si3.space/">Visit SI3 Ecosystem</a> </div> </div> <div class="footer"> This is an automated confirmation email. If you didn’t fill out the form, please ignore this message. </div> </div> </body></html>
  `;
};
...
export const partnerSubmissionTemplate = (
  ...
  return `
    <!DOCTYPE html><html lang="en"> <head> <meta charset="UTF-8" /> <meta name="viewport" content="width=device-width, initial-scale=1" /> <title>Si Her Partner Application</title> <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Montserrat:wght@500;700&display=swap" rel="stylesheet" /> <style> body { margin: 0; padding: 0; background-color: #f4f4f4; font-family: 'Inter', Arial, sans-serif; } .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e0d5ff; } .header { background: linear-gradient( 121.07deg, #211257 5.49%, #4c1192 48.19%, #790eb4 75.74%, #8a04c5 86.22% ); color: #fff; padding: 24px; text-align: center; } .header h1 { margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; font-weight: 700; } .content { padding: 30px; color: #333; } .content p { font-size: 16px; line-height: 1.6; margin-top: 0; margin-bottom: 20px; color: #555; } .details-table { width: 100%; border-collapse: collapse; margin-top: 10px; } .details-table td { padding: 14px; vertical-align: top; font-size: 15px; } .details-table td.label { background-color: #faf5ff; color: #790eb4; font-weight: 600; width: 35%; border-bottom: 1px solid #eee; } .details-table td.value { background-color: #f9f9f9; color: #333; border-bottom: 1px solid #eee; } .footer { text-align: center; font-size: 13px; color: #999; padding: 20px; } @media only screen and (max-width: 600px) { .content { padding: 20px; } .details-table td { display: block; width: 100% !important; } .details-table td.label { border-bottom: none; } .details-table td.value { border-top: 0; padding-top: 4px; padding-bottom: 14px; } } </style> </head> <body> <div class="email-container"> <div class="header"> <h1>Si Her Partner Application</h1> </div> <div class="content"> <p>A new partnership application has been submitted:</p> <table class="details-table"> <tr> <td class="label">Name:</td> <td class="value">${
      data.name || "N/A"
    }</td> </tr> <tr> <td class="label">Email:</td> <td class="value">${
    data.email || "N/A"
...
export const partnerReplyTemplate = (data: PartnerSubmissionData): string => {
  return `
    <!DOCTYPE html><html lang="en"> <head> <meta charset="UTF-8" /> <meta name="viewport" content="width=device-width, initial-scale=1" /> <title>Thank You for Reaching Out!</title> <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Montserrat:wght@500;700&display=swap" rel="stylesheet" /> <style> body { margin: 0; padding: 0; background-color: #f4f4f4; font-family: 'Inter', Arial, sans-serif; } .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e0d5ff; } .header { background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #fff; padding: 24px; text-align: center; } .header h1 { margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; font-weight: 700; } .content { padding: 30px; color: #333; } .content p { font-size: 16px; line-height: 1.6; margin: 0 0 20px; color: #555; } .cta { text-align: center; margin-top: 30px; } .cta a { display: inline-block; padding: 12px 28px; background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #fff; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 16px; text-decoration: none; border-radius: 50px; } .footer { text-align: center; font-size: 13px; color: #999; padding: 20px; } @media only screen and (max-width: 600px) { .content { padding: 20px; } } </style> </head> <body> <div class="email-container"> <div class="header"> <h1>Thank You for Reaching Out!</h1> </div> <div class="content"> <p>Hi ${
      data.name || "there"
    },</p> <p>Thank you for reaching out to <strong>SI&lt;3&gt;</strong> through our Partner Application Form. We're thrilled to hear about your organization and ideas for collaboration.</p> <p>Our team will review your submission and get back to you shortly. In the meantime, feel free to browse our platform and learn more about what we’re building.</p> <div class="cta"> <a href="https://www.si3.space/">Visit SI3 Ecosystem</a> </div> </div> <div class="footer"> This is an automated confirmation email. If you didn’t fill out the form, please ignore this message. </div> </div> </body></html>
  `;
};
...
export const guidesReplyTemplate = (data: GuidesSubmissionData): string => {
  return `
    <!DOCTYPE html><html lang="en"> <head> <meta charset="UTF-8" /> <meta name="viewport" content="width=device-width, initial-scale=1" /> <title>Thank You for Applying!</title> <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Montserrat:wght@500;700&display=swap" rel="stylesheet" /> <style> body { margin: 0; padding: 0; background-color: #f4f4f4; font-family: 'Inter', Arial, sans-serif; } .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e0d5ff; } .header { background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #fff; padding: 24px; text-align: center; } .header h1 { margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; font-weight: 700; } .content { padding: 30px; color: #333; } .content p { font-size: 16px; line-height: 1.6; margin: 0 0 20px; color: #555; } .cta { text-align: center; margin-top: 30px; } .cta a { display: inline-block; padding: 12px 28px; background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #fff; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 16px; text-decoration: none; border-radius: 50px; } .footer { text-align: center; font-size: 13px; color: #999; padding: 20px; } @media only screen and (max-width: 600px) { .content { padding: 20px; } } </style> </head> <body> <div class="email-container"> <div class="header"> <h1>Thank You for Applying!</h1> </div> <div class="content"> <p>Hi ${
      data.name || "there"
    },</p> <p>Thank you for applying to become a <strong>Si Her Guide</strong>. We’ve received your application and are excited to learn more about your journey and interests in Web3.</p> <p>Our team will review your submission and reach out shortly with next steps. In the meantime, stay connected and feel free to explore our resources and community links.</p> <div class="cta"> <a href="https://www.si3.space/">Visit SI3 Ecosystem</a> </div> </div> <div class="footer"> This is an automated confirmation email. If you didn’t fill out the form, please ignore this message. </div> </div> </body></html>
  `;
};
...
export const otpEmailTemplate = (otp: string, email: string): string => {
  return `
    <!DOCTYPE html><html lang="en"> <head> <meta charset="UTF-8" /> <meta name="viewport" content="width=device-width, initial-scale=1.0" /> <title>SI&lt;3&gt; | OTP Verification</title> <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700&family=Inter:wght@400;500;600&display=swap" rel="stylesheet" /> <style> body { margin: 0; padding: 0; background-color: #eff8ff; font-family: 'Inter', sans-serif; } .container { max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.05); } .header { background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); color: #ffffff; text-align: center; padding: 32px 20px; } .header h1 { font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 28px; margin: 0; } .content { padding: 40px 30px; text-align: center; } .content h2 { font-family: 'Montserrat', sans-serif; font-size: 20px; font-weight: 600; color: #4C1192; margin-bottom: 24px; } .otp-box { display: inline-block; background-color: #f7f0fc; border: 2px dashed #8A04C5; border-radius: 16px; padding: 24px 32px; font-size: 36px; font-weight: 700; letter-spacing: 8px; color: #4C1192; font-family: 'Courier New', monospace; margin-bottom: 16px; } .expires { font-size: 14px; color: #790EB4; margin-top: 12px; } .warning { background-color: #fff1f2; border: 1px solid #fda4af; color: #b91c1c; padding: 16px; margin-top: 28px; border-radius: 12px; font-size: 14px; text-align: center; } .footer { background-color: #f3f4f6; padding: 20px; text-align: center; font-size: 13px; color: #6b7280; } .footer a { color: #4C1192; text-decoration: none; font-weight: 500; } </style> </head> <body> <div class="container"> <div class="header"> <h1>SI&lt;3&gt; LOGIN CODE</h1> <p style="margin: 8px 0 0; font-size: 15px; font-weight: 500;">Web3 Secure Access</p> </div> <div class="content"> <h2>Your One-Time Passcode</h2> <div class="otp-box">${otp}</div> <p class="expires">⏱️ Expires in ${
