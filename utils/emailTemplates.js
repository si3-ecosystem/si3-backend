...
export const scholarsProgramEmailTemplate = (data) => {
  return `
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 8px;">
      <div style="background-color: #fff; border-radius: 8px; border: 1px solid #eee;">
        <div style="padding: 20px; border-radius: 8px;">
          <h1 style="text-align: center; color: #F927E9; margin-bottom: 25px; border-bottom: 2px solid #C258FF; padding-bottom: 10px;">Scholars Program Application</h1>
          <p style="text-align: center; font-size: 16px; color: #666; margin-bottom: 20px;">
            A new scholar has applied to the Scholars Program. Here are the details:
          </p>
          <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <tr>
              <td style="padding: 12px; border-bottom: 1px solid #eee; background-color: #fff; font-weight: bold; color: #C258FF; width: 30%;">Name:</td>
            ...
            ${
              data.details
                ? `
            <tr>
              <td style="padding: 12px; border-bottom: 1px solid #eee; background-color: #fff; font-weight: bold; color: #C258FF;">Additional Details:</td>
              <td style="padding: 12px; border-bottom: 1px solid #eee; background-color: #f8f8f8; white-space: pre-line;">${data.details}</td>
            </tr>
            `
                : ""
            }
            <tr>
              <td style="padding: 12px; border-bottom: 1px solid #eee; background-color: #fff; font-weight: bold; color: #C258FF;">Newsletter Subscription:</td>
              <td style="padding: 12px; border-bottom: 1px solid #eee; background-color: #f8f8f8;">${
...
export const tempMail = () => {
  return `
   <!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="color-scheme" content="light dark"><meta name="supported-color-schemes" content="light dark"><title>SI HER KOLLAB</title><!-- FONT --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Oswald:wght@200..700&display=swap" rel="stylesheet"><style>body { -webkit-text-size-adjust: none; -ms-text-size-adjust: none;}@media (prefers-color-scheme: dark) { .body-wrapper { background-color: #1e1e1e !important; color: #ffffff !important; } .card { background-color: #2a2a2a !important; color: #ffffff !important; } .set-color-white { color: #fff !important; }}* {box-sizing: border-box;}@media only screen and (max-width: 600px) {.container {width: 100% !important;}.set-img-custom {height: 100%;width: 100%;object-fit: cover;}.ios-s {padding-right: 10px;}.set-pad-mobile {padding: 35px 40px !important;}.set-pad-12 {padding: 12px !important;}.set-pad-25 {padding: 10px 0px 25px 0px !important;}.set-pad-meet {padding-left: 10px !important;padding-right: 10px !important;}}</style></head><body style="margin:0; padding:0;" class="body-wrapper"><!-- MAIN TABLE --> <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; margin:0 auto; background-color:#EFF8FF;" class="body-wrapper"> <tr> <td> <!-- *************************** --> <!-- INNER TOP BAR --> <!-- *************************** --> <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse; margin: 0; padding: 0;"> <tr> <td style="margin: 0; padding: 0;"> <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); border-collapse: collapse;"> <tr> <td style="padding: 12px; text-align: center;"> <span style="font-family: 'Inter', sans-serif; font-weight: 400; font-size: 14px; line-height: 26px; color: #ffffff !important;" data-apple-color="white" class="set-color-white">ADVANCING WOMEN TO THE FOREFRONT OF WEB3</span> </td> </tr> </table> <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse; background-color: #ffffff;"> <tr> <td style="padding: 35px; text-align: center;"> <span style="font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 32px; line-height: 26px; color: #000000 !important;" data-apple-color="black">SI HER GUIDES</span> </td> </tr> </table> </td> </tr></table> <!-- *************************** --> <!-- INNER CONTENT --> <!-- *************************** --> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="padding: 35px 70px;text-align: center;" class="set-pad-mobile"> <h3 style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 20px;line-height: 27px;color:#4C1192;display: inline-block;display: block;margin: 0;">Dear Si Her Guides,</h3> <p style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 16px;line-height: 27px;color: #000;margin-top: 21px;margin-bottom: 0;">This is our first bi-weekly newsletter where we will share updates on the activities within our growing DAO. In each newsletter, we will share updates on our DAO activities, including initiatives to accelerate your voice and professional brand in the industry.</p> <p style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 16px;line-height: 27px;color: #000;margin-top: 28px;margin-bottom: 0;">We invite you to attend our bi-weekly calls on Thursdays, and share your ideas there and in our Telegram group. This DAO is being shaped by you, for you! </p> <p style="font-family: 'Inter', sans-serif;font-weight: 600;font-size: 16px;line-height: 27px;color: #000;margin-top: 28px;margin-bottom: 0;">With love,</p> <p style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 16px;line-height: 27px;color: #000;margin-top: 0px;margin-bottom: 0;">Kara</p> <a href="https://app.unlock-protocol.com/checkout?id=217e695c-93b7-4300-8fb9-e334194b1ba6" target="_blank" style="display: inline-block;padding: 13px 36px;background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%);font-family: 'Inter', sans-serif;font-weight: 600;font-size: 20px;line-height: 27px;color: #fff;text-decoration: none;border-radius: 50px;margin-top: 30px;" class="set-color-white">Claim Your Si Her Kollab NFT</a> </td> </tr> </table> <!-- *************************** --> <!-- CARD TABLE --> <!-- *************************** --> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="padding: 12px 32px 32px 32px;" class="set-pad-12"> <h2 style="text-align: center;font-family: 'Montserrat', sans-serif;font-weight: 700;font-size: 30px;line-height: 46px;color: #000;">Si Her Guide Highlights</h2> <!-- *************************** --> <!-- CARDS 1 --> <!-- *************************** --> <table style="border: 1px solid #F5EBFC;padding: 10px 10px 6px 10px;background-color: #fff;border-radius: 30px;margin-top: 18px;"> <tr> <td> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="width: 154px;height: 152px;border-radius: 18px;padding: 0;"> <img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3rbBmCaSXaZXseojyiA417uDb3ltHEKmSkNhd" alt="card-1" style="max-width: 100%;"> </td> <td style="padding-left: 16px;"> <a href="https://www.linkedin.com/posts/si3ecosystem_access-si3-womeninweb3-activity-7332910697590243328-iK4J?utm_source=share&utm_medium=member_desktop&rcm=ACoAADY3zREBb8wY_dXbXPMGcsVOlbg5Y3uEvxQ" target="_blank" style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 19px;line-height: 35px;color: #000;text-decoration: underline;">Collaboration in Web3</a> <p style="margin-top: 2px;margin-bottom: 0px;font-family: 'Inter', sans-serif;font-weight: 400;font-size: 18px;line-height: 26px;color: #3D3D3D;">Join in as we kick off our thought leadership series on the topic of Collaboration in Web3.</p> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- CARDS 2 --> <!-- *************************** --> <table style="border: 1px solid #F5EBFC;padding: 10px 10px 6px 10px;background-color: #fff;border-radius: 30px;margin-top: 18px;"> <tr> <td> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="width: 154px;height: 152px;border-radius: 18px;padding: 0;"> <img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3mSkrB79JEqwdDehWUt95zQfLs8y12xCX6Zpn" alt="card-1" style="max-width: 100%;"> </td> <td style="padding-left: 16px;"> <a href="https://www.linkedin.com/company/si3ecosystem/?trk=public_post_feed-actor-name" target="_blank" style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 19px;line-height: 35px;color: #000;text-decoration: underline;">Accessibility in Emerging Tech</a> <p style="margin-top: 2px;margin-bottom: 0px;font-family: 'Inter', sans-serif;font-weight: 400;font-size: 18px;line-height: 26px;color: #3D3D3D;">Contribute to the conversation your unique experience in creating accessibility within your community.</p> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- CARDS 3 --> <!-- *************************** --> <table style="border: 1px solid #F5EBFC;padding: 10px 10px 6px 10px;background-color: #fff;border-radius: 30px;margin-top: 18px;"> <tr> <td> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="width: 154px;height: 152px;border-radius: 18px;padding: 0;"> <img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3F65C4OrKupHhOvRDbGg368mctTU2VlLfeqsi" alt="card-1" style="max-width: 100%;"> </td> <td style="padding-left: 16px;"> <a style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 19px;line-height: 35px;color: #000;text-decoration: none;">Si Her Guides Telegram</a> <p style="margin-top: 2px;margin-bottom: 0px;font-family: 'Inter', sans-serif;font-weight: 400;font-size: 18px;line-height: 26px;color: #3D3D3D;">Explore our evolving Telegram group as we organize sub-channels and create a supportive digital environment.</p> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- CARDS 4 --> <!-- *************************** --> <table style="border: 1px solid #F5EBFC;padding: 10px 10px 6px 10px;background-color: #fff;border-radius: 30px;margin-top: 18px;"> <tr> <td> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="width: 154px;height: 152px;border-radius: 18px;padding: 0;text-align: center;"> <img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3KDDvyaS7SHk9mvYofnRdElzByg4pJhVsOXC0" alt="card-1" style="max-width: 100%;border-radius: 18px;"> </td> <td style="padding-left: 16px;"> <a style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 19px;line-height: 35px;color: #000;text-decoration: none;">SiHer.Eth Site</a> <p style="margin-top: 2px;margin-bottom: 0px;font-family: 'Inter', sans-serif;font-weight: 400;font-size: 18px;line-height: 26px;color: #3D3D3D;">We are excited to introduce you to our unique personal brand website template, with IPFS storage, .eth domain, crypto tipping, and livestreaming coming soon!</p> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- 2x BLOCK IMAGE --> <!-- *************************** --> <table style="padding: 25px;background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); margin-top: 41px;text-align: center;border-top-left-radius: 20px;border-top-right-radius: 20px;width: 100%;"> <tr> <td style="width: 100%;font-family: 'Oswald', sans-serif;font-weight: 500;font-size: 32px;line-height: 100%;color: #fff;" class="set-color-white"> SI HER GUIDE </td> </tr> </table> <table style="padding: 22px 0px 40px 0px;background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%);border-bottom-right-radius: 20px;border-bottom-left-radius: 20px;" class="set-pad-25"> <tr> <td> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="width: 35%;padding: 0;text-align: center;"> <img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3H9ETSERzdDTkCO5JwnF1EASt3srPvm7Kg4hR" alt="card-1" style="max-width: 100%;"> </td> <td style="padding-left: 16px;padding-right: 21px;width: 50%;"> <span style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 19px;line-height: 30px;color: #fff;display: inline-block;margin-top: 8px;" class="set-color-white">Si Her Guide BI-Weekly Session: July 4th @ 11 am CST</span> <p style="margin-top: 12px;margin-bottom: 0px;font-family: 'Inter', sans-serif;font-weight: 300;font-size: 16px;line-height: 25px;color: #fff;" class="set-color-white">Join us for our second Si Her Guide session where share our SiHer.Eth personal brand sites, and explore match-making and mentorship opportunities.</p> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- INTRODUCING --> <!-- *************************** --> <table style="padding: 21px;background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%); margin-top: 41px;text-align: center;border-top-left-radius: 20px;border-top-right-radius: 20px;width: 100%;border-spacing: 0;"> <tr> <td style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 32px;line-height: 100%;color: #fff;width: 100%;display: block;"> <span class="set-color-white">Meet Your DAO Initiator</span> </td> </tr> </table> <table style="padding: 0px;background-color: #D7E0F2;border-spacing: 0;"> <tr> <td style="padding: 0px;"> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container" style="border-spacing: 0;"> <tr style="vertical-align: top;"> <td style="width: 50%;height: 229px;border-radius: 18px;padding: 0;"> <img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3OolAJIi3R8uV1KW0IsPNwTtaDGCYeAX2MUZo" alt="card-1" style="max-width: 100%;width: 100%;" class="set-img-custom"> </td> <td style="padding-left: 16px;padding-right: 21px;width: 50%;" class="set-pad-meet"> <span style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 17px;line-height: 26px;color: #000;display: inline-block;margin-top: 8px;">INTRODUCING</span> <h3 style="font-family: 'Montserrat', sans-serif;font-weight: 700;font-size: 24px;line-height: 27px;color: #4C1192;display: inline-block;display: block;margin: 0;margin-top: 6px;">KARA HOWARD</h3> <span style="font-family: 'Montserrat', sans-serif;font-weight: 600;font-size: 15px;line-height: 26px;color: #000;margin-top: 6px;display: inline-block;">SI<3> Ecosystem Lead</span> <p style="margin-top: 12px;margin-bottom: 0px;font-family: 'Inter', sans-serif;font-weight: 400;font-size: 13px;line-height: 21px;color: #000000B2;">Kara has been a women-in-tech community leader for twelve years, and experiences shared value as other women experience success.</p> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- SOCIAL --> <!-- *************************** --> <table style="padding: 0px;background-color: #D7E0F2;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;width: 100%;border-spacing: 0;margin-top: -4px;"> <tr> <td style="padding: 0px;"> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container" style="border-spacing: 0;"> <tr style="vertical-align: top;"> <td style="width: 50%;height: 64px;background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%);text-align: center;padding: 20px;border-bottom-left-radius: 20px;"> <table cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left: auto;margin-right: auto;border-spacing: 0;"> <tr style="vertical-align: center"> <td><img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3df1YHDVfxtpB6Z4RUnS7Ig8LsFNj1z20TYQy" alt="globe"></td> <td><a href="https://karahoward.siher.eth.link/" target="_blank" style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 13px;line-height: 18px;color: #fff;padding-left: 10px;">karahoward.siher.eth.link</a></td> </tr> </table> </td> <td style="width: 100%; max-width: 50%;height: 64px;background: #F1EFFC;text-align: center;padding: 20px;border-bottom-right-radius: 20px;"> <table cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left: auto;margin-right: auto;border-spacing: 0;"> <tr style="vertical-align:center"> <td><img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3yKwFguzJ3pTRA5F9QbKXW4HjrEcmDoSiM2ts" alt="globe"></td> <td><a href="https://www.linkedin.com/in/decentralizing/" target="_blank" style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 13px;line-height: 18px;color: #000;padding-left: 10px;">@decentralizing</a></td> </tr> </table> </td> </tr> </table> </td> </tr> </table> </td> </tr> </table> <!-- *************************** --> <!-- FOOTER --> <!-- *************************** --> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <tr> <td style="padding: 41px 36px 54px 36px;background: linear-gradient(121.07deg, #211257 5.49%, #4C1192 48.19%, #790EB4 75.74%, #8A04C5 86.22%);text-align: center;"> <span style="display:block;font-family: 'Inter', sans-serif;font-weight: 400;font-size: 15px;line-height: 34px;letter-spacing: 5px;text-align: center;text-transform: uppercase;color: #fff;" class="set-color-white">WE ARE GRATEFUL FOR YOU</span> <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container"> <td style="width: 100%; max-width: 33.33%;" class="ios-s"> <table style="background-color: #fff;border-radius: 12px;padding: 13px 7px;margin-top: 22px;width: 92%;"> <tr> <td> <table cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left: auto;margin-right: auto;"> <tr style="vertical-align: center"> <td><img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3rGgMNyXaZXseojyiA417uDb3ltHEKmSkNhdv" alt="x" height="23px" width="23px"></td> <td><a href="https://x.com/si3_ecosystem" target="_blank" style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 13px;line-height: 18px;color: #141414;padding-left: 8px;">@si3_ecosystem</a></td> </tr> </table> </td> </tr> </table> </td> <td style="width: 100%; max-width: 33.33%;" class="ios-s"> <table style="background-color: #fff;border-radius: 12px;text-align:center;padding: 13px 7px;margin-top: 22px; width: 92%;"> <tr> <td> <table cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left: auto;margin-right: auto;"> <tr style="vertical-align: center"> <td><img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3aIIbDeGODKWs5EFubyQqtSw4CXUfoHvBgjA3" alt="globe" height="23px" width="23px"></td> <td><a href="https://www.si3.space/" target="_blank" style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 13px;line-height: 18px;color: #141414;padding-left: 8px;">www.si3.space</a></td> </tr> </table> </td> </tr> </table> </td> <td style="width: 100%; max-width: 33.33%;" class="ios-s"> <table style="background-color: #fff;border-radius: 12px;padding: 13px 7px;margin-top: 22px;width: 92%;text-align: center;"> <tr> <td> <table cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left: auto;margin-right: auto;"> <tr style="vertical-align: center;"> <td><img src="https://tbjpbn89yx.ufs.sh/f/Wxv4gGErZaS3P96ByZfbc60wbBCVzD7nRyxS52mNQT1kptga" alt="linkedin" height="22px" width="22px"></td> <td><a href="https://www.linkedin.com/company/si3ecosystem/" target="_blank" style="font-family: 'Inter', sans-serif;font-weight: 400;font-size: 13px;line-height: 18px;color: #141414;padding-left: 8px;">@si3ecosystem</a></td> </tr> </table> </td> </tr> </table> </td> </table> </td> </tr> </table> </td> </tr> </table></body></html>
  `;
};
