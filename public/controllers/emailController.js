...
exports.sendPartnerProgramSubmissionEmail = exports.sendGuideSubmissionEmail = exports.sendScholarsProgramSubmissionEmail = exports.sendDiversityTrackerSubmissionEmail = exports.sendBulkEmail = exports.sendBasicEmail = exports.getSMTPStatus = void 0;
 ...
 * }
 */
exports.sendScholarsProgramSubmissionEmail = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { formData } = req.body;
    if (!formData) {
        return next(new AppError_1.default("Missing form data", 400));
    }
 ...
 * }
 */
exports.sendPartnerProgramSubmissionEmail = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { formData } = req.body;
    if (!formData || !formData.email || !formData.name) {
        return next(new AppError_1.default("Missing form data, email, or name", 400));
    }
    ...
    const adminNotificationResult = yield protonMail_1.default.sendEmail({
        ...
        toName: "SI<3> Team",
        toEmail: "kara@si3.space",
        subject: `New Partnership Application: ${data.name} - ${data.companyName || "Company Name"}`,
        htmlContent: adminNotificationHtml,
        emailType: "partner",
    });
    // Generate confirmation email content for the applicant
